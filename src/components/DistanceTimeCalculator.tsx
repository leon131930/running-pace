...
const DistanceTimeCalculator = ({ unit }: DistanceTimeCalculatorProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {calculatedPace && (
        <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-blue-300/10">
